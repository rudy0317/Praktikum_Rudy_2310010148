...
<body>
  <div class="shell">
    <h1 class="title">
      ...
      <span>Form Tambah Mahasiswa</span>
      <span class="badge">Rudy • 2310010148</span>
    </h1>

    <div class="card">
      <form action="<?= site_url('mahasiswa/simpan') ?>" method="post" autocomplete="off" class="grid">
        <div class="row">
          <div>
            <label for="nim">NIM</label>
            <input type="text" name="nim" id="nim" class="field" placeholder="Contoh: 2310010148" required>
          </div>
          <div>
            <label for="nama_mhs">Nama Mahasiswa</label>
            <input type="text" name="nama_mhs" id="nama_mhs" class="field" placeholder="Nama lengkap" required>
          </div>
          <div>
        ...
        <div class="actions">
          ...
          <a href="<?= site_url('mahasiswa') ?>" class="btn btn-ghost" role="button">Kembali</a>
        </div>

        <p class="help">Pastikan NIM dan nama sesuai data akademik.</p>
      </form>
    </div>
